...
#         user = self.add_user(name="John Doe", email="john.doe@example.com")
#         projects = [
#             {"name": "Project A", "description": "Description A", "user_id": user.id},
#             {"name": "Project B", "description": "Description B", "user_id": user.id}
#         ]
#         for project in projects:
#             self.client.post('/projects', json=project)
#
#         response = self.client.get(f'/projects/{user.id}')
#         assert response.status_code == 200
#         assert len(response.json) == 2
